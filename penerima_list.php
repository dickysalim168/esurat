...
$layout = new TLayout("list8","FusionBlueWave","MobileBlueWave");
...
$layout->blocks["top"][] = "toplinks";$page_layouts["penerima_list"] = $layout;
...
{	
	...
	//determine which field should be used to select values
			$params["lookupSelectField"] = "jenis";
				}
...
$layout = new TLayout("masterlist","FusionBlueWave","MobileBlueWave");
