...
require_once("include/surat_Kepada_variables.php");
...
$layout = new TLayout("Muza_Table", "FusionAqua", "MobileAqua");
$layout->version = 1;
...
$layout->containers["searchp"] = array();
$layout->container_properties["searchp"] = array(  );
$layout->containers["searchp"][] = array("name"=>"searchpanel", 
	"block"=>"searchPanel", "substyle"=>1  );

$layout->skins["searchp"] = "1";

$layout->blocks["top"][] = "searchp";
$page_layouts["surat_Kepada_list"] = $layout;
