<?php
include_once(getabspath("include/Tindakkan_settings.php"));

function DisplayMasterTableInfo_Tindakkan($params)
{
...
$layout->blocks["bare"][] = "mastergrid";$page_layouts["Tindakkan_masterlist"] = $layout;
...
//	catatan - 
	...
	$layout = GetPageLayout("Tindakkan", 'masterlist');
	if($layout)
		$xt->assign("pageattrs", 'class="'.$layout->style." page-".$layout->name.'"');
	
	$xt->display("Tindakkan_masterlist.htm");
