...
Runner.pages.PageSettings.addPageEvent("surat_Agensi",Runner.pages.constants.PAGE_EDIT,"afterPageReady",function(pageObj,proxy,pageid){pageObj.buttonNames[pageObj.buttonNames.length]='New_Button16';if(!pageObj.buttonEventBefore['New_Button16']){pageObj.buttonEventBefore['New_Button16']=function(params,ctrl,pageObj,proxy,pageid,rowData){history.go(-1);return;}}
