<?php 
class eventclass_surat_maklumatsurat  extends eventsBase
{ 
	function eventclass_surat_maklumatsurat()
	{
	// fill list of events
...
//	onscreen events
		$this->events["surat_snippet110"] = true;
...
//	onscreen events
function surat_snippet110(&$params)
{
// Put your code here.
