...
function checkTableName($shortTName, $type=false)
{
	...
	if ("surat" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("status" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("surat_individu" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("surat_jenis" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("awam" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("agensi" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("drop_level" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("pengguna" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("Viewer" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("surat_view" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("menuview" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("surat_Kepada" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("surat_editor" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("surat_maklumatsurat" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("surat_PTG" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("surat_AgensiAwam" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("surat_Awam" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("suratview2" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("pejawatan_ref_department" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("pejawatan_ref_position" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("drop_kategori" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("TambahPenerima" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("SuratKepada" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("agensi_awam" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	return false;
}
...
function GetTablesList($pdfMode = false)
{
	...
	$strPerm = GetUserPermissions("surat_individu");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="surat_individu";
	}
	$strPerm = GetUserPermissions("surat_jenis");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="surat_jenis";
	}
	$strPerm = GetUserPermissions("awam");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="awam";
	}
	$strPerm = GetUserPermissions("agensi");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="agensi";
	}
	$strPerm = GetUserPermissions("drop_level");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="drop_level";
	}
	$strPerm = GetUserPermissions("pengguna");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="pengguna";
	}
	$strPerm = GetUserPermissions("Viewer");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="Viewer";
	}
	$strPerm = GetUserPermissions("surat_view");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="surat_view";
	}
	$strPerm = GetUserPermissions("menuview");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="menuview";
	}
	$strPerm = GetUserPermissions("surat_Kepada");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="surat_Kepada";
	}
	$strPerm = GetUserPermissions("surat_editor");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="surat_editor";
	}
	$strPerm = GetUserPermissions("surat_maklumatsurat");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="surat_maklumatsurat";
	}
	$strPerm = GetUserPermissions("surat_PTG");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="surat_PTG";
	}
	$strPerm = GetUserPermissions("surat_AgensiAwam");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="surat_AgensiAwam";
	}
	$strPerm = GetUserPermissions("surat_Awam");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="surat_Awam";
	}
	$strPerm = GetUserPermissions("suratview2");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="suratview2";
	}
	$strPerm = GetUserPermissions("pejawatan_ref_department");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="pejawatan_ref_department";
	}
	$strPerm = GetUserPermissions("pejawatan_ref_position");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="pejawatan_ref_position";
	}
	$strPerm = GetUserPermissions("drop_kategori");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="drop_kategori";
	}
	$strPerm = GetUserPermissions("TambahPenerima");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="TambahPenerima";
	}
	$strPerm = GetUserPermissions("SuratKepada");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="SuratKepada";
	}
	$strPerm = GetUserPermissions("agensi_awam");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="agensi_awam";
	}
...
function GetUserPermissionsStatic( $table )
{
	...
	if($table=="surat" && $sUserGroup=="1")
	{
			return "AEDSPI".$extraPerm;
	}
	if($table=="surat" && $sUserGroup=="2")
	{
			return "AEDSPI".$extraPerm;
	}
	if($table=="surat" && $sUserGroup=="3")
	{
			return "S".$extraPerm;
	}
//	default permissions	
	...
	if($table=="status" && $sUserGroup=="1")
	{
			return "AEDSPI".$extraPerm;
	}
	if($table=="status" && $sUserGroup=="2")
	{
			return "AEDSPI".$extraPerm;
	}
	if($table=="status" && $sUserGroup=="3")
	{
			return "".$extraPerm;
	}
//	default permissions	
	...
	if($table=="surat_individu" && $sUserGroup=="1")
	{
			return "AEDSPI".$extraPerm;
	}
	if($table=="surat_individu" && $sUserGroup=="2")
	{
			return "AEDSPI".$extraPerm;
	}
	if($table=="surat_individu" && $sUserGroup=="3")
	{
			return "AEDSPI".$extraPerm;
	}
//	default permissions	
	if($table=="surat_individu")
	{
		return "AEDSPI".$extraPerm;
	}
	if($table=="surat_jenis" && $sUserGroup=="1")
	{
			return "AEDSPI".$extraPerm;
	}
	if($table=="surat_jenis" && $sUserGroup=="2")
	{
			return "AEDSPI".$extraPerm;
	}
	if($table=="surat_jenis" && $sUserGroup=="3")
	{
			return "".$extraPerm;
	}
//	default permissions	
	if($table=="surat_jenis")
	{
		return "AEDSPI".$extraPerm;
	}
	if($table=="awam" && $sUserGroup=="1")
	{
			return "AEDSPI".$extraPerm;
	}
	if($table=="awam" && $sUserGroup=="2")
	{
			return "AEDSPI".$extraPerm;
	}
	if($table=="awam" && $sUserGroup=="3")
	{
			return "".$extraPerm;
	}
//	default permissions	
	...
	if($table=="agensi" && $sUserGroup=="1")
	{
			return "AEDSPI".$extraPerm;
	}
	if($table=="agensi" && $sUserGroup=="2")
	{
			return "AEDSPI".$extraPerm;
	}
	if($table=="agensi" && $sUserGroup=="3")
	{
			return "".$extraPerm;
	}
//	default permissions	
	...
	if($table=="drop_level" && $sUserGroup=="1")
	{
			return "AEDSPI".$extraPerm;
	}
	if($table=="drop_level" && $sUserGroup=="2")
	{
			return "AEDSPI".$extraPerm;
	}
	if($table=="drop_level" && $sUserGroup=="3")
	{
			return "".$extraPerm;
	}
//	default permissions	
	...
	if($table=="pengguna" && $sUserGroup=="1")
	{
			return "AEDSPI".$extraPerm;
	}
	if($table=="pengguna" && $sUserGroup=="2")
	{
			return "".$extraPerm;
	}
	if($table=="pengguna" && $sUserGroup=="3")
	{
			return "".$extraPerm;
	}
//	default permissions	
	...
	if($table=="Viewer" && $sUserGroup=="1")
	{
			return "AEDSPI".$extraPerm;
	}
	if($table=="Viewer" && $sUserGroup=="2")
	{
			return "AEDSPI".$extraPerm;
	}
	if($table=="Viewer" && $sUserGroup=="3")
	{
			return "AEDSPI".$extraPerm;
	}
//	default permissions	
	...
	if($table=="surat_view" && $sUserGroup=="1")
	{
			return "AEDSPI".$extraPerm;
	}
	if($table=="surat_view" && $sUserGroup=="2")
	{
			return "AEDSPI".$extraPerm;
	}
	if($table=="surat_view" && $sUserGroup=="3")
	{
			return "AEDSPI".$extraPerm;
	}
//	default permissions	
	...
	if($table=="menuview" && $sUserGroup=="1")
	{
			return "AEDSPI".$extraPerm;
	}
	if($table=="menuview" && $sUserGroup=="2")
	{
			return "AEDSPI".$extraPerm;
	}
	if($table=="menuview" && $sUserGroup=="3")
	{
			return "AEDSPI".$extraPerm;
	}
//	default permissions	
	...
	if($table=="surat_Kepada" && $sUserGroup=="1")
	{
			return "AEDSPI".$extraPerm;
	}
	if($table=="surat_Kepada" && $sUserGroup=="2")
	{
			return "AEDSPI".$extraPerm;
	}
	if($table=="surat_Kepada" && $sUserGroup=="3")
	{
			return "".$extraPerm;
	}
//	default permissions	
	if($table=="surat_Kepada")
	{
		return "".$extraPerm;
	}
	if($table=="surat_editor" && $sUserGroup=="1")
	{
			return "AEDSPI".$extraPerm;
	}
	if($table=="surat_editor" && $sUserGroup=="2")
	{
			return "AEDSPI".$extraPerm;
	}
	if($table=="surat_editor" && $sUserGroup=="3")
	{
			return "".$extraPerm;
	}
//	default permissions	
	if($table=="surat_editor")
	{
		return "".$extraPerm;
	}
	if($table=="surat_maklumatsurat" && $sUserGroup=="1")
	{
			return "AEDSPI".$extraPerm;
	}
	if($table=="surat_maklumatsurat" && $sUserGroup=="2")
	{
			return "AEDSPI".$extraPerm;
	}
	if($table=="surat_maklumatsurat" && $sUserGroup=="3")
	{
			return "".$extraPerm;
	}
//	default permissions	
	if($table=="surat_maklumatsurat")
	{
		return "".$extraPerm;
	}
	if($table=="surat_PTG" && $sUserGroup=="1")
	{
			return "AEDSPI".$extraPerm;
	}
	if($table=="surat_PTG" && $sUserGroup=="2")
	{
			return "AEDSPI".$extraPerm;
	}
	if($table=="surat_PTG" && $sUserGroup=="3")
	{
			return "".$extraPerm;
	}
//	default permissions	
	...
	if($table=="surat_AgensiAwam" && $sUserGroup=="1")
	{
			return "AEDSPI".$extraPerm;
	}
	if($table=="surat_AgensiAwam" && $sUserGroup=="2")
	{
			return "AEDSPI".$extraPerm;
	}
	if($table=="surat_AgensiAwam" && $sUserGroup=="3")
	{
			return "".$extraPerm;
	}
//	default permissions	
	if($table=="surat_AgensiAwam")
	{
		return "".$extraPerm;
	}
	if($table=="surat_Awam" && $sUserGroup=="1")
	{
			return "AEDSPI".$extraPerm;
	}
	if($table=="surat_Awam" && $sUserGroup=="2")
	{
			return "AEDSPI".$extraPerm;
	}
	if($table=="surat_Awam" && $sUserGroup=="3")
	{
			return "".$extraPerm;
	}
//	default permissions	
	...
	if($table=="suratview2" && $sUserGroup=="1")
	{
			return "AEDSPI".$extraPerm;
	}
	if($table=="suratview2" && $sUserGroup=="2")
	{
			return "ES".$extraPerm;
	}
	if($table=="suratview2" && $sUserGroup=="3")
	{
			return "".$extraPerm;
	}
//	default permissions	
	...
	if($table=="pejawatan_ref_department" && $sUserGroup=="1")
	{
			return "AEDSPI".$extraPerm;
	}
	if($table=="pejawatan_ref_department" && $sUserGroup=="2")
	{
			return "S".$extraPerm;
	}
	if($table=="pejawatan_ref_department" && $sUserGroup=="3")
	{
			return "S".$extraPerm;
	}
//	default permissions	
	if($table=="pejawatan_ref_department")
	{
		return "S".$extraPerm;
	}
	if($table=="pejawatan_ref_position" && $sUserGroup=="1")
	{
			return "AEDSPI".$extraPerm;
	}
	if($table=="pejawatan_ref_position" && $sUserGroup=="2")
	{
			return "S".$extraPerm;
	}
	if($table=="pejawatan_ref_position" && $sUserGroup=="3")
	{
			return "S".$extraPerm;
	}
//	default permissions	
	if($table=="pejawatan_ref_position")
	{
		return "S".$extraPerm;
	}
	if($table=="drop_kategori" && $sUserGroup=="1")
	{
			return "AEDSPI".$extraPerm;
	}
	if($table=="drop_kategori" && $sUserGroup=="2")
	{
			return "S".$extraPerm;
	}
	if($table=="drop_kategori" && $sUserGroup=="3")
	{
			return "S".$extraPerm;
	}
//	default permissions	
	if($table=="drop_kategori")
	{
		return "S".$extraPerm;
	}
	if($table=="TambahPenerima" && $sUserGroup=="1")
	{
			return "AEDSPI".$extraPerm;
	}
	if($table=="TambahPenerima" && $sUserGroup=="2")
	{
			return "AEDSPI".$extraPerm;
	}
	if($table=="TambahPenerima" && $sUserGroup=="3")
	{
			return "AEDSPI".$extraPerm;
	}
//	default permissions	
	if($table=="TambahPenerima")
	{
		return "AEDSPI".$extraPerm;
	}
	if($table=="SuratKepada" && $sUserGroup=="1")
	{
			return "".$extraPerm;
	}
	if($table=="SuratKepada" && $sUserGroup=="2")
	{
			return "".$extraPerm;
	}
	if($table=="SuratKepada" && $sUserGroup=="3")
	{
			return "".$extraPerm;
	}
//	default permissions	
	if($table=="SuratKepada")
	{
		return "".$extraPerm;
	}
	if($table=="agensi_awam" && $sUserGroup=="1")
	{
			return "AEDSPI".$extraPerm;
	}
	if($table=="agensi_awam" && $sUserGroup=="2")
	{
			return "AEDSPI".$extraPerm;
	}
	if($table=="agensi_awam" && $sUserGroup=="3")
	{
			return "S".$extraPerm;
	}
//	default permissions	
	if($table=="agensi_awam")
	{
		return "S".$extraPerm;
	}
...
function AfterFBLogIn($pUsername, $pPassword, &$pageObject = null)
{
	...
	$strSQL = "select * from ".$connection->addTableWrappers("pengguna")
...
function SetAuthSessionData($pUsername, &$data, $fromFacebook, $password, &$pageObject = null)
{
	...
	$_SESSION["GroupID"] = $data["Level"];
		...
		$_SESSION["OwnerID"] = $data["pid"];
	$_SESSION["_surat_individu_OwnerID"] = $data["pid"];
		$_SESSION["_Viewer_OwnerID"] = $data["pid"];
		$_SESSION["_surat_view_OwnerID"] = $data["pid"];
		$_SESSION["_surat_Kepada_OwnerID"] = $data["pid"];
		$_SESSION["_surat_editor_OwnerID"] = $data["iid"];
