<?php 
class eventclass_surat_PTG  extends eventsBase
{ 
	function eventclass_surat_PTG()
	{
	// fill list of events
...
//	onscreen events
		$this->events["surat_snippet1101"] = true;
...
//**********  Redirect to another page  ************
header("Location: surat_edit.php?editid1=".$_SESSION['siid']);
exit();
...
//	onscreen events
function surat_snippet1101(&$params)
{
// Put your code here.
