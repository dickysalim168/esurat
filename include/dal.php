...
function UsersTableName()
{
	...
	return $connection->addTableWrappers("pengguna");
}
...
class tDAL
{
	var $tblTables__agensi;
	var $tblTables__agensi_awam;
	var $tblTables__awam;
	var $tblTables__drop_kategori;
	var $tblTables__drop_level;
	var $tblTables__pejawatan_ref_department;
	var $tblTables__pejawatan_ref_position;
	var $tblTables__pejawatan_staffdetails;
	var $tblTables__pengguna;
	var $tblTables__status;
	var $tblTables__surat;
	var $tblTables__surat_individu;
	var $tblTables__surat_jenis;
	var $tblTables__surat_view;
	var $lstTables;
	var $Table = array();
	...
	function FillTablesList()
	{
		if($this->lstTables)
			return;
		$this->lstTables[] = array("name" => "agensi", "varname" => "Tables__agensi", "altvarname" => "agensi", "connId" => "Tables", "schema" => "", "connName" => "esurat at localhost");
		$this->lstTables[] = array("name" => "agensi_awam", "varname" => "Tables__agensi_awam", "altvarname" => "agensi_awam", "connId" => "Tables", "schema" => "", "connName" => "esurat at localhost");
		$this->lstTables[] = array("name" => "awam", "varname" => "Tables__awam", "altvarname" => "awam", "connId" => "Tables", "schema" => "", "connName" => "esurat at localhost");
		$this->lstTables[] = array("name" => "drop_kategori", "varname" => "Tables__drop_kategori", "altvarname" => "drop_kategori", "connId" => "Tables", "schema" => "", "connName" => "esurat at localhost");
		$this->lstTables[] = array("name" => "drop_level", "varname" => "Tables__drop_level", "altvarname" => "drop_level", "connId" => "Tables", "schema" => "", "connName" => "esurat at localhost");
		$this->lstTables[] = array("name" => "pejawatan_ref_department", "varname" => "Tables__pejawatan_ref_department", "altvarname" => "pejawatan_ref_department", "connId" => "Tables", "schema" => "", "connName" => "esurat at localhost");
		$this->lstTables[] = array("name" => "pejawatan_ref_position", "varname" => "Tables__pejawatan_ref_position", "altvarname" => "pejawatan_ref_position", "connId" => "Tables", "schema" => "", "connName" => "esurat at localhost");
		$this->lstTables[] = array("name" => "pejawatan_staffdetails", "varname" => "Tables__pejawatan_staffdetails", "altvarname" => "pejawatan_staffdetails", "connId" => "Tables", "schema" => "", "connName" => "esurat at localhost");
		$this->lstTables[] = array("name" => "pengguna", "varname" => "Tables__pengguna", "altvarname" => "pengguna", "connId" => "Tables", "schema" => "", "connName" => "esurat at localhost");
		$this->lstTables[] = array("name" => "status", "varname" => "Tables__status", "altvarname" => "status", "connId" => "Tables", "schema" => "", "connName" => "esurat at localhost");
		$this->lstTables[] = array("name" => "surat", "varname" => "Tables__surat", "altvarname" => "surat", "connId" => "Tables", "schema" => "", "connName" => "esurat at localhost");
		$this->lstTables[] = array("name" => "surat_individu", "varname" => "Tables__surat_individu", "altvarname" => "surat_individu", "connId" => "Tables", "schema" => "", "connName" => "esurat at localhost");
		$this->lstTables[] = array("name" => "surat_jenis", "varname" => "Tables__surat_jenis", "altvarname" => "surat_jenis", "connId" => "Tables", "schema" => "", "connName" => "esurat at localhost");
		$this->lstTables[] = array("name" => "surat_view", "varname" => "Tables__surat_view", "altvarname" => "surat_view", "connId" => "Tables", "schema" => "", "connName" => "esurat at localhost");
	}
