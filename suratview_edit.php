...
$layout->blocks["top"][] = "details";$page_layouts["suratview_edit"] = $layout;
...
$templatefile = "suratview_edit.htm";
...
//	processing Minit - begin
	$condition = $inlineedit==EDIT_INLINE;//($inlineedit) inline mode

	if($condition)
	{
		$control_Minit = $pageObject->getControl("Minit", $id);
		$control_Minit->readWebValue($evalues, $blobfields, $strWhereClause, $oldValuesRead, $efilename_values);
...
if ($IsSaved && no_output_done() && $inlineedit == EDIT_SIMPLE)
{
	...
	// redirect
	header("Location: suratview_".$pageObject->getPageType().".php?".$keyGetQ);
...
$xt->assign("viewlink_attrs","id=\"viewButton".$id."\" name=\"viewButton".$id."\" onclick=\"window.location.href='suratview_view.php?".$viewlink."'\"");
