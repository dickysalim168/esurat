      ...
      foreach ($data as $dat) {
         ...
         if ($dat != "." && $dat != ".." && $dat != "_notes" && $info['extension'] != "") { ?>
          ...
          <td> &nbsp; <b><?php  echo date ("d/m/Y", filemtime($folder)); ?></b>  </td> 
           ...
           <td> &nbsp; <a href="pdfjs.php?f=<?php echo $info['basename'];?>" target="myIframe">Lihat</a> | <a href="<?php echo $info['dirname']."/".$info['basename'];?>" title="Download" download>Muat Turun</a> | <a href="copy.php?f=<?php echo $info['basename'];?>" onclick="return confirm('Adakah Anda Pasti?')">Pilih</a></td>
           </tr>
       	 <?php };
      };
    }else{
