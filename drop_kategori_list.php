...
require_once("include/drop_kategori_variables.php");
...
$layout = new TLayout("centered_vert2", "FusionAqua", "MobileAqua");
$layout->version = 2;
...
$layout->blocks["left"][] = "recordcontrols";
...
$layout->blocks["left"][] = "pagination_bottom";
...
$page_layouts["drop_kategori_list"] = $layout;
