...
$layout->blocks["top"][] = "details";$page_layouts["jawatan_view"] = $layout;
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='jawatan_edit.php?".$editlink."'\"");
