...
include("include/delete_penerima_variables.php");
...
$layout->blocks["top"][] = "search";$page_layouts["delete_penerima_search"] = $layout;
...
$mode = SEARCH_SIMPLE;
$templatefile = "delete_penerima_search.htm";
...
$params['shortTableName'] = 'delete_penerima';
...
if ($mode==SEARCH_SIMPLE)
{
	...
	// search fields data
	$categoryFieldParams = $pageObject->searchClauseObj->getSearchCtrlParams("jenis");
	$categoryFieldVal = '';
	...
	$fieldParams = $pageObject->searchClauseObj->getSearchCtrlParams('bahagian');
	$fieldVal = '';
	...
	// search fields data
	$categoryFieldParams = $pageObject->searchClauseObj->getSearchCtrlParams("jawatan");
	$categoryFieldVal = '';
	if (count($categoryFieldParams))
	{
		$categoryFieldVal = $categoryFieldParams[0]['value1'];
	...
	$fieldParams = $pageObject->searchClauseObj->getSearchCtrlParams('individu');
	$fieldVal = '';
	if (count($fieldParams))
	{
		$fieldVal = $fieldParams[0]['value1'];
