...
$layout->blocks["top"][] = "details";$page_layouts["bahagian_agensi_view"] = $layout;
...
$arr = array();
$arr['fName'] = "jid";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("jid");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "namaBahagian";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("namaBahagian");
$fieldsArr[] = $arr;
...
//jid - 
	...
	if($mainTableOwnerID=="jid")
		$ownerIdValue=$value;
	$xt->assign("jid_value",$value);
...
//namaBahagian - 
	...
	if($mainTableOwnerID=="namaBahagian")
		$ownerIdValue=$value;
	$xt->assign("namaBahagian_value",$value);
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='bahagian_agensi_edit.php?".$editlink."'\"");
