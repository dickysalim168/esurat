...
var Plugin = document.embeds[0];
    ...
    var redirectURLifOK = "scansurat/done.php";
		...
		{
		   // btnUploadInner("esurat.selangor.gov.my", 80, strActionPage, redirectURLifOK);
		Plugin.HTTPUploadThroughPost(strHostIP, i, strActionPage, "<?php echo $_SESSION['sid'];?>-<?php echo time();?>.jpg");
				i++;
		}
