...
include("include/Kepada1_variables.php");
...
$layout->blocks["top"][] = "details";$page_layouts["Kepada1_edit"] = $layout;
...
$templatefile = ($inlineedit == EDIT_INLINE) ? "Kepada1_inline_edit.htm" : "Kepada1_edit.htm";
...
if ($IsSaved && no_output_done() && $inlineedit == EDIT_SIMPLE)
{
	...
	// redirect
	header("Location: Kepada1_".$pageObject->getPageType().".php?".$keyGetQ);
...
if(!$data)
{
	...
	{
		header("Location: Kepada1_list.php?a=return");
		exit();
	}
	else
		$data = array();
...
$xt->assign("viewlink_attrs","id=\"viewButton".$id."\" name=\"viewButton".$id."\" onclick=\"window.location.href='Kepada1_view.php?".$viewlink."'\"");
