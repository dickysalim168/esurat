...
$layout->blocks["top"][] = "details";$page_layouts["hapus_edit"] = $layout;
...
$templatefile = ($inlineedit == EDIT_INLINE) ? "hapus_inline_edit.htm" : "hapus_edit.htm";
...
if ($IsSaved && no_output_done() && $inlineedit == EDIT_SIMPLE)
{
	...
	// redirect
	header("Location: hapus_".$pageObject->getPageType().".php?".$keyGetQ);
...
if(!$data)
{
	...
	{
		header("Location: hapus_list.php?a=return");
		exit();
	}
	else
		$data = array();
...
$xt->assign("viewlink_attrs","id=\"viewButton".$id."\" name=\"viewButton".$id."\" onclick=\"window.location.href='hapus_view.php?".$viewlink."'\"");
