...
$layout = new TLayout("add2old", "FusionAqua", "MobileAqua");
$layout->version = 1;
...
$page_layouts["menuview_add"] = $layout;
...
$layout = new TLayout("tab", "FusionAqua", "MobileAqua");
$layout->version = 2;
...
$page_layouts["menuview_add_PTG1"] = $layout;
...
$layout->blocks["bare"][] = "1";
$page_layouts["menuview_add_Agensi1"] = $layout;
...
$layout->blocks["bare"][] = "1";
$page_layouts["menuview_add_Awam1"] = $layout;
