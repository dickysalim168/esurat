...
$layout->blocks["top"][] = "details";$page_layouts["delete_penerima_view"] = $layout;
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='delete_penerima_edit.php?".$editlink."'\"");
