...
$layout->blocks["top"][] = "details";$page_layouts["surat_editor_view"] = $layout;


$layout = new TLayout("viewtab","BoldAqua","MobileAqua");
...
$layout->blocks["bare"][] = "1";$page_layouts["surat_editor_view_PTG1"] = $layout;
...
$layout->skins["1"] = "fields";
$layout->blocks["bare"][] = "1";$page_layouts["surat_editor_view_Agensi1"] = $layout;
...
$layout->skins["1"] = "fields";
$layout->blocks["bare"][] = "1";$page_layouts["surat_editor_view_Awam1"] = $layout;
...
if (!sizeof($data)) {
	header("Location: surat_editor_list.php?a=return");
	exit();
}
...
$arr = array();
$arr['fName'] = "Minit";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("Minit");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "Catatan";
...
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "Penghantar";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("Penghantar");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "Penerima";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("Penerima");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "status";
...
//Tarikh - Short Date
	...
	if($mainTableOwnerID=="Tarikh")
		$ownerIdValue=$value;
	$xt->assign("Tarikh_value",$value);
...
//Minit - 
	...
	if($mainTableOwnerID=="Minit")
		$ownerIdValue=$value;
	$xt->assign("Minit_value",$value);
	if(!$pageObject->isAppearOnTabs("Minit"))
		$xt->assign("Minit_fieldblock",true);
	else
		$xt->assign("Minit_tabfieldblock",true);
////////////////////////////////////////////
//Catatan - 
	
	$value = $pageObject->showDBValue("Catatan", $data, $keylink);
	if($mainTableOwnerID=="Catatan")
		$ownerIdValue=$value;
	$xt->assign("Catatan_value",$value);
...
//Penghantar - 
	...
	if($mainTableOwnerID=="Penghantar")
		$ownerIdValue=$value;
	$xt->assign("Penghantar_value",$value);
...
//Penerima - 
	...
	if($mainTableOwnerID=="Penerima")
		$ownerIdValue=$value;
	$xt->assign("Penerima_value",$value);
...
//siid - 
	...
	if($mainTableOwnerID=="siid")
		$ownerIdValue=$value;
	$xt->assign("siid_value",$value);
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='surat_editor_edit.php?".$editlink."'\"");
