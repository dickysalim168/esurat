...
class ConnectionManager
{
	...
	protected function _setConnectionsData()
	{
		...
		$data["dbType"] = 0;
		$data["connId"] = "Tables";
		$data["connName"] = "esurat at localhost";
		$data["connStringType"] = "mysql";
		$data["connectionString"] = "mysql;localhost;root;;3306;esurat;;1"; //currently unused
		
		$this->_connectionsIdByName["esurat at localhost"] = "Tables";
		...
		$data["connInfo"][4] = "esurat";
		$data["connInfo"][5] = ""; //currently unused
		$data["connInfo"][6] = "1"; //currently unused
		$data["ODBCString"] = "DRIVER={MySQL ODBC 3.51 Driver};Server=localhost;Uid=root;Pwd=;Port=3306;Database=esurat;OPTION=3";
	...
	protected function _setTablesConnectionIds()
	{
		...
		$connectionsIds["surat"] = "Tables";
		$connectionsIds["status"] = "Tables";
		$connectionsIds["surat_individu"] = "Tables";
		$connectionsIds["surat_jenis"] = "Tables";
		$connectionsIds["awam"] = "Tables";
		$connectionsIds["agensi"] = "Tables";
		$connectionsIds["drop_level"] = "Tables";
		$connectionsIds["pengguna"] = "Tables";
		$connectionsIds["Viewer"] = "Tables";
		$connectionsIds["surat_view"] = "Tables";
		$connectionsIds["menuview"] = "Tables";
		$connectionsIds["surat_Kepada"] = "Tables";
		$connectionsIds["surat_editor"] = "Tables";
		$connectionsIds["surat_maklumatsurat"] = "Tables";
		$connectionsIds["surat_PTG"] = "Tables";
		$connectionsIds["surat_AgensiAwam"] = "Tables";
		$connectionsIds["surat_Awam"] = "Tables";
		$connectionsIds["suratview2"] = "Tables";
		$connectionsIds["pejawatan_ref_department"] = "Tables";
		$connectionsIds["pejawatan_ref_position"] = "Tables";
		$connectionsIds["drop_kategori"] = "Tables";
		$connectionsIds["TambahPenerima"] = "Tables";
		$connectionsIds["SuratKepada"] = "Tables";
		$connectionsIds["agensi_awam"] = "Tables";
