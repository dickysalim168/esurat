...
<TABLE border=0 width="100%" >
  ...
  <TR>
  <TD width=20>&nbsp;</TD>
    <TD><img src='mailcloudlogo2.png' width="130" height="110"></TD>
    <TD width=300>
        <br>
        <font color='black'>
      <?php
...
?>
    <TD width=610>&nbsp;</TD>
    <TD><img src='aldercylogo.png' height="90" width="190"></TD>
<?php
}
?>
      </TD></TR>
...
";
?>
<li ".isactive2('pengguna_list')."> <a href="#" onclick="window.open('extras/index.php','Laporan','width=900,height=530').focus()">Laporan</a></li>
<?php   
