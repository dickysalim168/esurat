...
<div class="span2">
 ...
 <p><b>Laporan Keseluruhan Pendaftaran Sistem PTGS Mengikut Tahun & Bahagian</b></p>  


<form method='get' action='laporan_keseluruhantahun_generate.php'>
PILIH TAHUN
<br>
Tahun :
...
<?php
 ...
 echo "Bahagian : <select name='bahagian'>";
 
 if(empty($_GET['bahagian']))
 {
     $_GET['bahagian'] = "";
 }
