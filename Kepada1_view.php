...
$layout->blocks["top"][] = "details";$page_layouts["Kepada1_view"] = $layout;
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='Kepada1_edit.php?".$editlink."'\"");
