...
$layout->blocks["top"][] = "details";$page_layouts["individu_add"] = $layout;
...
if($inlineadd == ADD_INLINE)
	$templatefile = "individu_inline_add.htm";
else
	$templatefile = "individu_add.htm";
...
if(isset($_REQUEST['afteradd'])){
		header('Location: individu_add.php');
			...
			if($inlineadd==ADD_SIMPLE || $inlineadd==ADD_MASTER)
			{
				...
				if (count($keys))
				{
					...
					if($pageObject->pSet->hasEditPage() && $permis['edit'])
						$message .='&nbsp;<a href=\'individu_edit.php?'.$keylink.'\'>'."Kemaskini".'</a>&nbsp;';
					if($pageObject->pSet->hasViewPage() && $permis['search'])
						$message .='&nbsp;<a href=\'individu_view.php?'.$keylink.'\'>'."Lihat".'</a>&nbsp;';
				}
				$mesClass = "mes_ok";	
			}
		}
...
if (no_output_done() && $inlineadd==ADD_SIMPLE && $IsSaved)
{
	...
	// redirect
	header("Location: individu_".$pageObject->getPageType().".php");
