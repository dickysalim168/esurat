...
$layout->blocks["top"][] = "details";$page_layouts["InboxPergerakanSurat_edit"] = $layout;
...
$layout->blocks["bare"][] = "1";$page_layouts["InboxPergerakanSurat_edit_PTG1"] = $layout;
...
$layout->skins["1"] = "fields";
$layout->blocks["bare"][] = "1";$page_layouts["InboxPergerakanSurat_edit_Agensi1"] = $layout;
...
$layout->skins["1"] = "fields";
$layout->blocks["bare"][] = "1";$page_layouts["InboxPergerakanSurat_edit_Awam1"] = $layout;
...
$templatefile = "InboxPergerakanSurat_edit.htm";
...
if ($IsSaved && no_output_done() && $inlineedit == EDIT_SIMPLE)
{
	...
	// redirect
	header("Location: InboxPergerakanSurat_".$pageObject->getPageType().".php?".$keyGetQ);
...
if(!$data)
{
	...
	{
		header("Location: InboxPergerakanSurat_list.php?a=return");
		exit();
	}
	else
		$data = array();
...
$xt->assign("viewlink_attrs","id=\"viewButton".$id."\" name=\"viewButton".$id."\" onclick=\"window.location.href='InboxPergerakanSurat_view.php?".$viewlink."'\"");
