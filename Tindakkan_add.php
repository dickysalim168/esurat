...
$layout->blocks["top"][] = "details";$page_layouts["Tindakkan_add"] = $layout;
...
if($inlineadd == ADD_INLINE)
	$templatefile = "Tindakkan_inline_add.htm";
else
	$templatefile = "Tindakkan_add.htm";
...
if(isset($_REQUEST['afteradd'])){
		header('Location: Tindakkan_add.php');
			...
			if($inlineadd==ADD_SIMPLE || $inlineadd==ADD_MASTER)
			{
				...
				if (count($keys))
				{
					...
					if($pageObject->pSet->hasEditPage() && $permis['edit'])
						$message .='&nbsp;<a href=\'Tindakkan_edit.php?'.$keylink.'\'>'."Sunting".'</a>&nbsp;';
					if($pageObject->pSet->hasViewPage() && $permis['search'])
						$message .='&nbsp;<a href=\'Tindakkan_view.php?'.$keylink.'\'>'."Lihat".'</a>&nbsp;';
				}
				$mesClass = "mes_ok";	
			}
		}
...
if (no_output_done() && $inlineadd==ADD_SIMPLE && $IsSaved)
{
	...
	// redirect
	header("Location: Tindakkan_".$pageObject->getPageType().".php");
