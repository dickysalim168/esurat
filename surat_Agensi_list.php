...
require_once("include/surat_Agensi_variables.php");
...
$layout = new TLayout("list71", "FusionAqua", "MobileAqua");
$layout->version = 1;
...
$layout->blocks["top"][] = "left";
$page_layouts["surat_Agensi_list"] = $layout;
