...
class CrossTableReport
{
	...
	public function isProjectDB()
	{
		...
		$isDB = false;
		if("surat" == $this->xml_array['tables'][0])
			$isDB = true;
		if("status" == $this->xml_array['tables'][0])
			$isDB = true;
		if("surat_individu" == $this->xml_array['tables'][0])
			$isDB = true;
		if("surat_jenis" == $this->xml_array['tables'][0])
			$isDB = true;
		if("awam" == $this->xml_array['tables'][0])
			$isDB = true;
		if("agensi" == $this->xml_array['tables'][0])
			$isDB = true;
		if("drop_level" == $this->xml_array['tables'][0])
			$isDB = true;
		if("pengguna" == $this->xml_array['tables'][0])
			$isDB = true;
		if("surat_individu" == $this->xml_array['tables'][0])
			$isDB = true;
		if("surat_view" == $this->xml_array['tables'][0])
			$isDB = true;
		if("surat" == $this->xml_array['tables'][0])
			$isDB = true;
		if("pejawatan_staffdetails" == $this->xml_array['tables'][0])
			$isDB = true;
		if("surat_individu" == $this->xml_array['tables'][0])
			$isDB = true;
		if("surat" == $this->xml_array['tables'][0])
		...
		if("surat" == $this->xml_array['tables'][0])
			$isDB = true;
		if("pejawatan_ref_department" == $this->xml_array['tables'][0])
			$isDB = true;
		if("pejawatan_ref_position" == $this->xml_array['tables'][0])
			$isDB = true;
		if("drop_kategori" == $this->xml_array['tables'][0])
			$isDB = true;
		if("pengguna" == $this->xml_array['tables'][0])
			$isDB = true;
		if("pengguna" == $this->xml_array['tables'][0])
			$isDB = true;
		if("agensi_awam" == $this->xml_array['tables'][0])
			$isDB = true;
		return $isDB;
	}
