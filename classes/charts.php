...
class Chart
{
	...
	protected function isProjectDB()
	{
		...
		if("status" == $this->chrt_array['tables'][0])
			return true;
		if("surat_individu" == $this->chrt_array['tables'][0])
			return true;
		if("surat_jenis" == $this->chrt_array['tables'][0])
			return true;
		if("awam" == $this->chrt_array['tables'][0])
			return true;
		if("agensi" == $this->chrt_array['tables'][0])
			return true;
		if("drop_level" == $this->chrt_array['tables'][0])
			return true;
		if("pengguna" == $this->chrt_array['tables'][0])
			return true;
		if("surat_individu" == $this->chrt_array['tables'][0])
			return true;
		if("surat_view" == $this->chrt_array['tables'][0])
			return true;
		if("surat" == $this->chrt_array['tables'][0])
			return true;
		if("pejawatan_staffdetails" == $this->chrt_array['tables'][0])
			return true;
		if("surat_individu" == $this->chrt_array['tables'][0])
			return true;
		if("surat" == $this->chrt_array['tables'][0])
		...
		if("surat" == $this->chrt_array['tables'][0])
			return true;
		if("pejawatan_ref_department" == $this->chrt_array['tables'][0])
			return true;
		if("pejawatan_ref_position" == $this->chrt_array['tables'][0])
			return true;
		if("drop_kategori" == $this->chrt_array['tables'][0])
			return true;
		if("pengguna" == $this->chrt_array['tables'][0])
			return true;
		if("pengguna" == $this->chrt_array['tables'][0])
			return true;
		if("agensi_awam" == $this->chrt_array['tables'][0])
			return true;
		return false;
	}
