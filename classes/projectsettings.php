...
class ProjectSettings
{
	...
	*/
	...
	{
		return new ProjectSettings("pengguna", PAGE_LIST);
	}
...
function GetTableURL($table = "")
{
	...
	if("status" == $table)
		return "status";
	if("surat_individu" == $table)
		return "surat_individu";
	if("surat_jenis" == $table)
		return "surat_jenis";
	if("awam" == $table)
		return "awam";
	if("agensi" == $table)
	...
	if("menuview" == $table)
		return "menuview";
	if("surat_Kepada" == $table)
		return "surat_Kepada";
	if("surat_editor" == $table)
		return "surat_editor";
	if("surat_maklumatsurat" == $table)
		return "surat_maklumatsurat";
	if("surat_PTG" == $table)
		return "surat_PTG";
	if("surat_AgensiAwam" == $table)
		return "surat_AgensiAwam";
	if("surat_Awam" == $table)
		return "surat_Awam";
	if("suratview2" == $table)
		return "suratview2";
	if("pejawatan_ref_department" == $table)
		return "pejawatan_ref_department";
	if("pejawatan_ref_position" == $table)
		return "pejawatan_ref_position";
	if("drop_kategori" == $table)
		return "drop_kategori";
	if("TambahPenerima" == $table)
		return "TambahPenerima";
	if("SuratKepada" == $table)
		return "SuratKepada";
	if("agensi_awam" == $table)
		return "agensi_awam";
...
function GetTableByShort($shortTName = "")
{
	...
	if("status" == $shortTName)
		return "status";
	if("surat_individu" == $shortTName)
		return "surat_individu";
	if("surat_jenis" == $shortTName)
		return "surat_jenis";
	if("awam" == $shortTName)
		return "awam";
	if("agensi" == $shortTName)
		return "agensi";
	if("drop_level" == $shortTName)
		return "drop_level";
	if("pengguna" == $shortTName)
		return "pengguna";
	if("Viewer" == $shortTName)
		return "Viewer";
	if("surat_view" == $shortTName)
		return "surat_view";
	if("menuview" == $shortTName)
		return "menuview";
	if("surat_Kepada" == $shortTName)
		return "surat_Kepada";
	if("surat_editor" == $shortTName)
		return "surat_editor";
	if("surat_maklumatsurat" == $shortTName)
		return "surat_maklumatsurat";
	if("surat_PTG" == $shortTName)
		return "surat_PTG";
	if("surat_AgensiAwam" == $shortTName)
		return "surat_AgensiAwam";
	if("surat_Awam" == $shortTName)
		return "surat_Awam";
	if("suratview2" == $shortTName)
		return "suratview2";
	if("pejawatan_ref_department" == $shortTName)
		return "pejawatan_ref_department";
	if("pejawatan_ref_position" == $shortTName)
		return "pejawatan_ref_position";
	if("drop_kategori" == $shortTName)
		return "drop_kategori";
	if("TambahPenerima" == $shortTName)
		return "TambahPenerima";
	if("SuratKepada" == $shortTName)
		return "SuratKepada";
	if("agensi_awam" == $shortTName)
		return "agensi_awam";
}
