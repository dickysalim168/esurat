...
if($inlineadd == ADD_INLINE)
	$templatefile = "insert_surat_individu_inline_add.htm";
else
	$templatefile = "insert_surat_individu_add.htm";
...
if(isset($_REQUEST['afteradd'])){
		header('Location: insert_surat_individu_add.php');
			...
			if($inlineadd==ADD_SIMPLE || $inlineadd==ADD_MASTER)
			{
				...
				if (count($keys))
				{
					...
					if($pageObject->pSet->hasEditPage() && $permis['edit'])
						$message .='&nbsp;<a href=\'insert_surat_individu_edit.php?'.$keylink.'\'>'."Edit".'</a>&nbsp;';
					if($pageObject->pSet->hasViewPage() && $permis['search'])
						$message .='&nbsp;<a href=\'insert_surat_individu_view.php?'.$keylink.'\'>'."View".'</a>&nbsp;';
				}
				$mesClass = "mes_ok";	
			}
		}
...
if (no_output_done() && $inlineadd==ADD_SIMPLE && $IsSaved)
{
	...
	// redirect
	header("Location: insert_surat_individu_".$pageObject->getPageType().".php");
