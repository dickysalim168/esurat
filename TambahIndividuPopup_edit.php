...
$layout->blocks["top"][] = "details";$page_layouts["TambahIndividuPopup_edit"] = $layout;
...
$templatefile = ($inlineedit == EDIT_INLINE) ? "TambahIndividuPopup_inline_edit.htm" : "TambahIndividuPopup_edit.htm";
...
if ($IsSaved && no_output_done() && $inlineedit == EDIT_SIMPLE)
{
	...
	// redirect
	header("Location: TambahIndividuPopup_".$pageObject->getPageType().".php?".$keyGetQ);
...
$xt->assign("viewlink_attrs","id=\"viewButton".$id."\" name=\"viewButton".$id."\" onclick=\"window.location.href='TambahIndividuPopup_view.php?".$viewlink."'\"");
