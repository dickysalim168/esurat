...
$layout->blocks["top"][] = "search";$page_layouts["PergerakanSurat_list"] = $layout;
...
$viewControls = new ViewControlsContainer(new ProjectSettings("suratview", PAGE_LIST), PAGE_LIST);
