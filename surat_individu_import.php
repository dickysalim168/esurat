...
function ImportFromExcel($uploadfile)
{
	...
	for($k=0; $k<count($keys); $k++)
	{
		...
		if(in_array("siid",$fields))
		$autoinc=true;
							if(in_array("iid1",$fields))
		$autoinc=true;
...
$layout = new TLayout("import2","FusionBlueWave","MobileBlueWave");
...
$layout->blocks["top"][] = "import";$page_layouts["surat_individu_import"] = $layout;
...
$xt->display("surat_individu_import.htm");
