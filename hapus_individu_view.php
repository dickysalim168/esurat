...
$layout->blocks["top"][] = "details";$page_layouts["hapus_individu_view"] = $layout;
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='hapus_individu_edit.php?".$editlink."'\"");
