...
$layout->blocks["top"][] = "details";$page_layouts["insert_penerima_view"] = $layout;
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='insert_penerima_edit.php?".$editlink."'\"");
