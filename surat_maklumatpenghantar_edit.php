...
include("include/surat_maklumatpenghantar_variables.php");
...
$layout->blocks["top"][] = "details";$page_layouts["surat_maklumatpenghantar_edit"] = $layout;
...
$layout->blocks["bare"][] = "1";$page_layouts["surat_maklumatpenghantar_edit_PTG1"] = $layout;
...
$layout->skins["1"] = "fields";
$layout->blocks["bare"][] = "1";$page_layouts["surat_maklumatpenghantar_edit_Agensi1"] = $layout;
...
$layout->skins["1"] = "fields";
$layout->blocks["bare"][] = "1";$page_layouts["surat_maklumatpenghantar_edit_Awam1"] = $layout;
...
$templatefile = "surat_maklumatpenghantar_edit.htm";
...
if ($IsSaved && no_output_done() && $inlineedit == EDIT_SIMPLE)
{
	...
	// redirect
	header("Location: surat_maklumatpenghantar_".$pageObject->getPageType().".php?".$keyGetQ);
...
if(!$data)
{
	...
	{
		header("Location: surat_maklumatpenghantar_list.php?a=return");
		exit();
	}
	else
		$data = array();
...
if($pageObject->isShowDetailTables && $inlineedit!=EDIT_INLINE && !isMobile())
{
	...
	for($d=0;$d<count($dpParams['ids']);$d++)
	{
		...
		$options['masterTable'] = "surat_maklumatpenghantar";
		$options['firstTime'] = 1;
...
$xt->assign("viewlink_attrs","id=\"viewButton".$id."\" name=\"viewButton".$id."\" onclick=\"window.location.href='surat_maklumatpenghantar_view.php?".$viewlink."'\"");
