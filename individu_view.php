...
$layout->blocks["top"][] = "details";$page_layouts["individu_view"] = $layout;
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='individu_edit.php?".$editlink."'\"");
