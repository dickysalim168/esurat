...
$layout->blocks["bare"][] = "detailspreviewgrid";$page_layouts["surat_individu_detailspreview"] = $layout;
...
{
	$where = "";
		$where .= GetFullFieldName("sid", $strTableName, false)."=".make_db_value("sid",$_SESSION[$strTableName."_masterkey1"]);
}
...
if($rowcount) {
	...
	//	iid - 
		    ...
		    $value = $viewContainer->showDBValue("iid", $data, $keylink);
			$row["iid_value"] = $value;
	//	Bahagian - 
			$viewContainer->recId = $recordsCounter;
		    $value = $viewContainer->showDBValue("Bahagian", $data, $keylink);
			$row["Bahagian_value"] = $value;
	//	Jawatan - 
			$viewContainer->recId = $recordsCounter;
...
$xt->load_template("surat_individu_detailspreview.htm");
