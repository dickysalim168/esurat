...
$layout->blocks["top"][] = "details";$page_layouts["penerima_view"] = $layout;
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='penerima_edit.php?".$editlink."'\"");
