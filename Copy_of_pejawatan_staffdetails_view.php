...
$layout->blocks["top"][] = "details";$page_layouts["Copy_of_pejawatan_staffdetails_view"] = $layout;
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='Copy_of_pejawatan_staffdetails_edit.php?".$editlink."'\"");
