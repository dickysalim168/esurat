...
$layout->blocks["top"][] = "details";$page_layouts["UserView_view"] = $layout;
...
$layout->blocks["top"][] = "search";$page_layouts["document_list"] = $layout;
...
{
	$ids = $id;
	$dpPermis = $pageObject->getPermissions("document");
	if ($dpPermis['search']){
		$mKeys["document"] = $pageObject->pSet->getMasterKeysByDetailTable("document");
		$dpParams['strTableNames'][] = "document";
		$dpParams['ids'][] = ++$ids;
	}
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='UserView_edit.php?".$editlink."'\"");
