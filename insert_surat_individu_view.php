...
$layout = new TLayout("view3","FusionBlueWave","MobileBlueWave");
...
$layout->blocks["top"][] = "details";$page_layouts["insert_surat_individu_view"] = $layout;
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='insert_surat_individu_edit.php?".$editlink."'\"");
