...
$objPHPExcel->setActiveSheetIndex(0)
            ...
            ->setCellValue('G2', "L2 : Laporan Surat Mengikut Jenis ") 
            ->setCellValue('G3', "Jenis: $jenist[$jenis] ") 
...
$surat = date("d-m-Y",strtotime($data['tarikhTerima']));
        ...
        $objPHPExcel->getActiveSheet()->SetCellValue('I'.$row, $jenist[$data['Jenis']]);
