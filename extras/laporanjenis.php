...
<div class="row-fluid">
  ...
  <div class="span10">
<form method='get' action='laporan_generateformatjenis.php'>
...
<p><b>Laporan Surat Mengikut Jenis</b></p>  
<b>PILIH TARIKH <b><br>   
Dari &nbsp; &nbsp; : 
...
Kategori &nbsp; &nbsp;: 
		...
		{
			echo '<option value="'.$data['jid'].'">'.$data['jenis'].'</option>';
 ...
 <?php
  ...
  echo " (<a href='laporanjenis_generate.php'>Set Semula</a>)";
