...
$layout->blocks["top"][] = "details";$page_layouts["tambah_individu_view"] = $layout;
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='tambah_individu_edit.php?".$editlink."'\"");
